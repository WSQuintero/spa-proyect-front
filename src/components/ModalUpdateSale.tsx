...
function ModalUpdateSale({
  ...
  const onSubmit = async (finalData: TableData) => {
    const { status } = await $Sales.update({
      token,
      body: {
        ...finalData,
    ...
    if (status) {
      ...
      setCreatedMessage("Venta actualizada correctamente")
      ...
      setCreatedMessage("Error al actualizar la venta")
              ...
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  <Controller
                    name="nameSale"
                    control={control}
                    defaultValue={initialState.nameSale}
                    render={({ field }) => (
                      <input
                        {...field}
                        type="text"
